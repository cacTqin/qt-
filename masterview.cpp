...
{
    qDebug()<<"goHistoryEditView";
    histroyEditView = new HistoryEditView(this, rowNo);
    pushWidgetToStackView(histroyEditView);
    connect(histroyEditView,SIGNAL(goPreviousView()),this,SLOT(goPreviousView()));
}
